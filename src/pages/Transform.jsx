...
export default function TransformPage() {
  useEffect(() => {
    console.log(
      "%c### TransformPage MOUNTED",
      "background: #0080ff; color: white; padding: 2px 6px;",
      performance.now()
    );
  }, []);
  ...
  const handleGenerate = async () => {
    console.log("%c>>> handleGenerate CALLED", "background: #ff0000; color: white; padding: 2px 6px;", performance.now());
    ...
    try {
      console.log("%c>>> CALLING RPC consume_credit_if_active NOW", "background: #ff8800; color: black; padding: 2px 6px;", performance.now());
